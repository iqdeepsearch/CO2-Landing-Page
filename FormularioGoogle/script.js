// ============================================================
// CO2·QField — V1 (estática, sem backend)
// ============================================================
...
// --- Formulário (Google Forms via iframe oculto) ---
const interesseForm = document.getElementById("interesse-form");
const formConfirm = document.getElementById("form-confirm");

if (interesseForm && formConfirm) {
  interesseForm.addEventListener("submit", () => {
    // O envio real acontece no iframe oculto (target="hidden_iframe"),
    // então não há resposta de sucesso/erro confiável por CORS.
    // Mostramos a confirmação de forma otimista após um pequeno atraso.
    setTimeout(() => {
